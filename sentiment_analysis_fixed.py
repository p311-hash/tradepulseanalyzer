...
class SentimentAnalyzer:
    ...
    def analyze_social_sentiment(self, symbol: str) -> Dict:
        ...
        try:
            ...
            social_sentiment = {
                'reddit': self._analyze_reddit_sentiment(search_symbol),
                'stocktwits': self._analyze_stocktwits_sentiment(search_symbol),
                'twitter': self._analyze_twitter_sentiment(search_symbol)
            }
