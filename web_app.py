"""
Web application for TradePulse Signals Bot

This module provides a standalone Flask web interface to display trading signals
and interact with the backtesting system. It's designed to be run separately from
the Telegram bot to avoid conflicts.
"""
...
# Initialize continuous learning system (read-only mode for web app)
try:
    learner = ContinuousLearningSystem()
    learner.load_data_only = True  # Don't attempt to update or save data
    logger.info("Initialized continuous learning system in read-only mode")
...
def run_backtest_handler():
    ...
    strategy = request.form.get('strategy', 'macd_crossover')
    ...
    <div class="container mt-4">
        ...
        <div class="alert alert-info">
            Running backtest for {pair} {timeframe} with {strategy} strategy...
        </div>
        <div class="card bg-dark border-info mb-4">
            <div class="card-header bg-dark border-info">
                <h2 class="h4 m-0">Backtest Parameters</h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Initial Balance:</strong> ${initial_balance}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card bg-dark border-secondary mb-4">
                    ...
                    <div class="card-body">
                        <div class="trading-chart">
                            <p class="text-center pt-5">Equity curve chart will appear here</p>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-3">
...
def run_comparison_handler():
    ...
    # Ensure we have strategies selected
    if not strategies:
        strategies = ['macd_crossover', 'rsi_strategy', 'bollinger_bands']
    ...
    strategy_names = {
        ...
        'tradepulse': 'TradePulse Strategy'
    }
    ...
    <div class="container mt-4">
        ...
        <div class="alert alert-info">
            Comparing {len(strategies)} strategies for {pair} {timeframe}
        </div>
        
        <div class="card bg-dark border-info mb-4">
            <div class="card-header bg-dark border-info">
                <h2 class="h4 m-0">Comparison Parameters</h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                ...
                <p><strong>Strategies:</strong> {', '.join([strategy_names.get(s, s) for s in strategies])}</p>
            </div>
        </div>
        ...
        <div class="card bg-dark border-secondary mb-4">
            ...
            <div class="card-body">
                <div class="trading-chart">
                    <p class="text-center pt-5">Comparison chart will appear here</p>
                </div>
